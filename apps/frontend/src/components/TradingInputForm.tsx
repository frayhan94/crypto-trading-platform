...
import type { TradingParams } from '@repo/types';
import Modal from './Modal';

interface ReactHookFormProps {
  onSubmit: (params: TradingParams) => Promise<void>;
  isLoading?: boolean;
}

export default function TradingInputFormComponent({ onSubmit, isLoading = false }: ReactHookFormProps) {
  ...
  const onFormSubmit = async (data: TradingFormData) => {
    try {
      // Convert to TradingParams format
